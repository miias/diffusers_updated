...
from diffusers_udated import AutoencoderKL, DDPMScheduler, DiffusionPipeline, StableDiffusionPipeline, UNet2DConditionModel
from diffusers_udated.optimization import get_scheduler
from diffusers_udated.training_utils import cast_training_params, compute_snr
from diffusers_udated.utils import check_min_version, convert_state_dict_to_diffusers, is_wandb_available
