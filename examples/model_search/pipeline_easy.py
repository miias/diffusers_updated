...
from diffusers_udated.loaders.single_file_utils import (
    VALID_URL_PREFIXES,
    _extract_repo_id_and_weights_name,
    infer_diffusers_model_type,
    load_single_file_checkpoint,
)
from diffusers_udated.pipelines.animatediff import AnimateDiffPipeline, AnimateDiffSDXLPipeline
from diffusers_udated.pipelines.auto_pipeline import (
    AutoPipelineForImage2Image,
    AutoPipelineForInpainting,
    AutoPipelineForText2Image,
)
from diffusers_udated.pipelines.controlnet import (
...
from diffusers_udated.pipelines.flux import FluxImg2ImgPipeline, FluxPipeline
...
from diffusers_udated.pipelines.stable_diffusion_3 import StableDiffusion3Img2ImgPipeline, StableDiffusion3Pipeline
from diffusers_udated.pipelines.stable_diffusion_xl import (
