...
from diffusers_udated import OnnxRuntimeModel, OnnxStableDiffusionPipeline, SchedulerMixin
...
try:
    from diffusers_udated.pipelines.onnx_utils import ORT_TO_NP_TYPE
except ImportError:
    ORT_TO_NP_TYPE = {
...
class OnnxStableDiffusionLongPromptWeightingPipeline(OnnxStableDiffusionPipeline):
    ...
    if version.parse(version.parse(diffusers_udated.__version__).base_version) >= version.parse("0.9.0"):
