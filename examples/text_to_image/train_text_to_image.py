...
from diffusers_udated import AutoencoderKL, DDPMScheduler, StableDiffusionPipeline, UNet2DConditionModel
from diffusers_udated.optimization import get_scheduler
from diffusers_udated.training_utils import EMAModel, compute_dream_and_update_latents, compute_snr
from diffusers_udated.utils import check_min_version, deprecate, is_wandb_available, make_image_grid
